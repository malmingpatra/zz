...
export default function EditMassalScreen() {
  ...
  async function handleSaveAll() {
    ...
    try {
      ...
      for (const id of Object.keys(drafts)) {
        ...
        const stockChanged = d.stock !== "" && newStock !== p.stock;
        const priceChanged = d.price !== "" && newPrice !== p.price;
  ...
  function renderItem({ item }: { item: ListItem }) {
    ...
    const stockDirty = d.stock !== "" && parseInt(d.stock) !== p.stock;
    const priceDirty = d.price !== "" && parseInt(d.price) !== p.price;
